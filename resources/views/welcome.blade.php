...
<div class="input-group">
  ...
  <button type="submit" class="btn btn-outline-primary">search</button>
        ...
        <div class="row gx-2 gx-lg-2 row-cols-4 row-cols-md-4 row-cols-xl-4 justify-content-center">
                   

        <h3>registered Users :{{count($users)}}</h3>
        <h3>registered Books :{{count($booksN)}}</h3>
        <h3>registered Genres :{{count($genresN)}}</h3>
        <h3>Active BK rentals :{{count($activeBorrowN)}}</h3>
      ...
      @endforeach
            ...
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="col mb-5">
                        ...
                        @endif
                            <!-- Product image-->
                            <img class="card-img-top"  src="{{url('storage/'.substr($book->cover_image ,7))}}" height ="70 px" witth= "50px" alt="..." />
                            <!-- Product details-->
