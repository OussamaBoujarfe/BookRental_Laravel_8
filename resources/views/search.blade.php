...
<div class="input-group">
  <input type="search" name ="search" value="{{$_GET['search']}}" class="form-control rounded" placeholder="Search by Title, Author :" aria-label="Search" aria-describedby="search-addon" />
